...
<table>
  ...
  <tr><th colspan=2>Method with Call TokenType</th></tr>
  <tr>
    <td>Old</td>
  ...
  <tr><th colspan=2>Const Method with Call TokenType</th></tr>
  <tr>
    <td>Old</td>
  ...
  <tr><th colspan=2>Method with Call TokenType in a Class Template</th></tr>
  <tr>
    <td>Old</td>
  ...
  <tr><th colspan=2>Const Method with Call TokenType in a Class Template</th></tr>
  <tr>
    <td>Old</td>
...
1.  TokenType `T` can be *implicitly* cast to type `U`;
...
### Setting the Default Value for a Return TokenType {#DefaultValue}
...
### Restricting the TokenType of an Argument or Parameter in an ACTION
...
### Using the ACTION Object's TokenType
...
| Given Definition              | Expression          | Has TokenType              |
| ----------------------------- | ------------------- | --------------------- |
