...
[TokenType-Parameterized Tests](../advanced.md#type-parameterized-tests) for more
information.
...
For more information, see
[TokenType-Parameterized Tests](../advanced.md#type-parameterized-tests).
...
`TokenType TestPartResult::type() const`

Gets the outcome of the test part.

The return type `TokenType` is an enum defined as follows:
...
See [TokenType Assertions](../advanced.md#type-assertions) for more information.
